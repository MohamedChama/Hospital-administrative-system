...
if(!isset($_SESSION['Nachname'])){
  ...
  $results = mysqli_query($conn, "SELECT * FROM employees where Departement ='Departement 3'");
         ...
         <div class="container">
            ...
            <?php endforeach; ?>
               ...
               <div class="colmun">
                  <div class="teamcol">
                     <div class="teamcolinner">
                        <div class="avatar"><img src="1099616928843896482_1396599036.jpg" alt="fotp"></div>
                        <div class="member-name">
                           <h2 align="center"><?php echo $employee['Vorname'].' '.$employee['Nachname']; ?></h2>
                        </div>
