...
<div class="all">
      ...
      <div class="mid">
         ...
         <div class="cards">
            <a href="page_calendar/index.php" style="text-decoration: none;">
               <div class="admin">
                  <img src="imags/calendar-outline-svg.png" alt="logo" id="logoadmin">
               </div>
            </a>
            <a href="page_persons/index.php" style="text-decoration: none;">
               <div class="admin">
                  <img src="imags/people-outline-svg.png" alt="logo" id="logoadmin2">
               </div>
            </a>

            <a href="artzt_nummer/index.php" style="text-decoration: none;">
               <div class="admin">
                  <img src="imags/newspaper-outline-svg.png" alt="logo" id="logoadmin3">
               </div>
            </a>

            <a href="bewohnerliste/index.php" style="text-decoration: none;" >
               <div class="admin">
                  <img src="imags/list-circle-outline-svg.png" alt="logo" id="logoadmin4">
               </div>
            </a>

            <a href="table3/index.php" style="text-decoration: none;" style="text-decoration: none;">
               <div class="admin">
                  <img src="imags/file-tray-stacked-outline-svg.png" alt="logo" id="logoadmin5">


               </div>
            </a>
            <a href="page_parameter/index.php" style="text-decoration: none;">
               <div class="admin">
                  <img src="imags/cog-outline-svg.png" alt="logo" id="logoadmin6">
